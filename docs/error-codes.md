...
Le backend émet **243 codes** en réponse HTTP. 36 d'entre eux ont
une phrase dédiée dans l'application ; les 207 suivants sont valides et rendus par
...
- `INVALID_GENDER` · `INVALID_GRACE` · `INVALID_GROUP`
- `INVALID_IDS` · `INVALID_JOB` · `INVALID_KID`
- `INVALID_LIST` · `INVALID_MEDIA` · `INVALID_MEETING`
- `INVALID_MEMBER` · `INVALID_MESSAGE` · `INVALID_MSG_IDS`
- `INVALID_MSISDN` · `INVALID_MUTED_UNTIL` · `INVALID_PARTICIPANT_ID`
...
- `PAYMENT_NOT_FOUND` · `PAYMENT_PENDING` · `PAYMENT_PROVIDER_ERROR`
- `PAYMENT_PROVIDER_UNKNOWN` · `PHONE_ALREADY_EXISTS` · `PHONE_NOT_FOUND`
- `PHONE_NOT_NUMERIC` · `PHONE_NOT_RESERVABLE` · `PHONE_REQUIRED`
- `PLAN_CODE_TAKEN` · `PLAN_NOT_FOUND` · `POLL_TOKEN_REQUIRED`
...
- `SUBSCRIPTION_REQUIRED` · `TARGET_CONVERSATION_IDS_REQUIRED` · `TEXT_REQUIRED`
