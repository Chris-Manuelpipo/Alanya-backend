...
Le backend émet **221 codes** en réponse HTTP. 36 d'entre eux ont
une phrase dédiée dans l'application ; les 185 suivants sont valides et rendus par
...
- `BACKUP_KEY_UNAVAILABLE` · `BIO_LIMIT` · `BLOCKS_REQUIRED`
...
- `INVALID_PHONE_LENGTH` · `INVALID_QR` · `INVALID_REFERENCE`
- `INVALID_ROLE` · `INVALID_ROOM_ID` · `INVALID_TOKEN`
...
- `PASSWORD_REQUIRED` · `PHONE_ALREADY_EXISTS` · `PHONE_NOT_FOUND`
- `PHONE_NOT_NUMERIC` · `PHONE_NOT_RESERVABLE` · `PHONE_REQUIRED`
- `POLL_TOKEN_REQUIRED` · `PROFILE_NOT_FOUND` · `PURGE_UNKNOWN`
- `QR_UNKNOWN_OR_EXPIRED` · `RATE_LIMITED` · `RECIPIENT_NOT_FOUND`
